...
export const Icons = {
  ...
  Sun: ({ className, strokeWidth = 2 }: IconProps) => (
  ...
  CloudRain: ({ className, strokeWidth = 2 }: IconProps) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
  ...
  Snow: ({ className, strokeWidth = 2 }: IconProps) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
  ...
  // 御朱印樣式圖示 (用於待辦事項完成)
  Goshuin: ({ className, strokeWidth = 2 }: IconProps) => (
