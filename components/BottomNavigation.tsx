...
export const BottomNavigation: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full md:w-auto md:left-1/2 md:-translate-x-1/2 md:bottom-8 z-50 transition-all duration-300 bg-wafu-paper/95 backdrop-blur-xl border-t border-wafu-indigo/5 md:bg-transparent md:backdrop-blur-none md:border-none">
       {/* 
          Update: Padding logic changed to `pb-[calc(env(safe-area-inset-bottom)+0.5rem)]`
          This ensures at least 0.5rem (8px) padding on Android, and adds to the Home Indicator area on iPhone.
       */}
       <div className="md:bg-wafu-paper/95 md:backdrop-blur-xl md:border md:border-wafu-indigo/10 md:rounded-full md:shadow-2xl shadow-[0_-5px_20px_rgba(24,54,84,0.02)] pb-[calc(env(safe-area-inset-bottom)+0.5rem)] pt-2 md:pb-1 md:px-8">
